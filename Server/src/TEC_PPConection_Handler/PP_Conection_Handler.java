    ...
    public void run(){
        try {
            ...
            if(linea==null){
                ...
                p_write.println(jugador.inicio=0); p_write.println(jugador.vidas=3);
                p_write.println(jugador.score=0); p_write.println(jugador.x_pos=179);
                p_write.println(jugador.y_pos=640); p_write.println(jugador.diferencia_y=0);
            }else{
                PP_Jugadores jugador1=new PP_Player();
                p_write.println(jugador1.inicio=1); p_write.println(jugador1.vidas=3);
